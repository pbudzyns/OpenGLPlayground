...
OBJModelIndexed indexModelVBO(const OBJModel& model)
{
	OBJModelIndexed modelIndexed;
	if (model.tangents.empty())
		indexVBO(model.vertices, model.uvs, model.normals,
			modelIndexed.indices, modelIndexed.vertices, modelIndexed.uvs, modelIndexed.normals);
	else
		indexVBO_TBN(
			model.vertices, model.uvs, model.normals, model.tangents, model.bitangents,
			modelIndexed.indices, modelIndexed.vertices, modelIndexed.uvs, modelIndexed.normals,
			modelIndexed.tangents, modelIndexed.bitangents
		);
