...
Text2D::Text2D(const std::string& texturePath)
{

	m_Program = Shader::LoadShader("res/shaders/textVertex.glsl", "res/shaders/textFragment.glsl");
	m_Text2DUniformID = glGetUniformLocation(Text2D::m_Program, "myTextureSampler");

	m_Text2DTextureID = loadDDS(texturePath);
